...
import { MessageList, Message, MessageUser } from './MessageList';
...
export interface ChatLayoutProps {
  ...
  onSendMessage?: (content: { text: string; attachments?: File[] }) => void;
...
export const ChatLayout: React.FC<ChatLayoutProps> = ({
  ...
  return (
    <div className="chatsdk-chat-layout">
      {/* Sidebar */}
      <div className={clsx('chatsdk-sidebar', sidebarCollapsed && 'chatsdk-sidebar-collapsed')}>
        <ChannelList
          channels={channels}
        ...
        {activeChannel ? (
          <>
            ...
            <div className="chatsdk-channel-header">
              ...
              <div className="chatsdk-header-info">
                <Avatar
                  src={activeChannel.image}
                  name={activeChannel.name}
                  size="md"
                  presence={activeChannel.isOnline ? 'online' : undefined}
                />
                <div className="chatsdk-header-details">
                  <h2 className="chatsdk-header-name">{activeChannel.name}</h2>
                  <p className="chatsdk-header-status">
              ...
              <div className="chatsdk-header-actions">
                <button className="chatsdk-header-action" aria-label="Voice call">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                </button>
                <button className="chatsdk-header-action" aria-label="Video call">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <polygon points="23 7 16 12 23 17 23 7" />
                    <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
                  </svg>
                </button>
                <button className="chatsdk-header-action" aria-label="Search">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="11" cy="11" r="8" />
                    <line x1="21" y1="21" x2="16.65" y2="16.65" />
                  </svg>
                </button>
                <button className="chatsdk-header-action" aria-label="More options">
          ...
          <div className="chatsdk-empty-channel">
            <div className="chatsdk-empty-icon">
