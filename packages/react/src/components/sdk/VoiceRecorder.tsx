...
export const VoiceRecorder: React.FC<VoiceRecorderProps> = ({
  ...
  if (!isRecording) {
    return (
      <button className="chatsdk-recorder-start" onClick={startRecording} aria-label="Start recording">
  ...
  return (
    <div className={clsx('chatsdk-recorder', isLocked && 'chatsdk-recorder-locked')}>
      {/* Recording Indicator */}
      <div className="chatsdk-recorder-indicator">
        <span className="chatsdk-recorder-dot" />
        <span className="chatsdk-recorder-label">Recording</span>
      </div>

      {/* Duration */}
      <span className="chatsdk-recorder-duration">{formatTime(duration)}</span>

      {/* Waveform Visualization */}
      <div className="chatsdk-recorder-waveform">
        {waveform.map((height, index) => (
          <div
            key={index}
            className="chatsdk-recorder-bar"
      ...
      {/* Controls */}
      <div className="chatsdk-recorder-controls">
        <button
          className="chatsdk-recorder-cancel"
        ...
        <button
          className="chatsdk-recorder-pause"
        ...
        <button
          className="chatsdk-recorder-send"
